...
class SubscriptionController {
    ...
    static async getOne(req, res) {
      ...
      `;
            const result = await (0, database_1.query)(sql, [id, req.user.id]);
    ...
    static async update(req, res) {
      ...
      `;
            const checkResult = await (0, database_1.query)(checkSql, [id, req.user.id]);
        ...
        RETURNING *
      `;
            const result = await (0, database_1.query)(updateSql, values);
            res.json({
                success: true,
    ...
    static async detect(req, res) {
        try {
            ...
            const result = await subscriptionDetector_1.SubscriptionDetectorService.detectSubscriptions(req.user.id);
            res.json({
                success: true,
    ...
    static async getStats(req, res) {
        ...
        WHERE user_id = $1
      `;
            const result = await (0, database_1.query)(sql, [req.user.id]);
